...
message = tk.Label(window, text="Face Recognition to Confirm Appointment", bg="#8d99ae",
                   fg="#edf2f4", width=50, height=3, font=('times', 30, 'italic bold underline'))

message.place(x=200, y=20)

lbl5 = tk.Label(window, text="Recognition Results : ", width=30,
                fg="#edf2f4", bg="#ef233c", height=2, font=('times', 15))
lbl5.place(x=400, y=200)


message2 = tk.Label(window, text="", fg="#edf2f4", bg="#ef233c",
                    activeforeground="green", width=50, height=5, font=('times', 15, ' bold '))
message2.place(x=800, y=200)

lbl6 = tk.Label(window, text="Token Generated : ", width=30,
                fg="#edf2f4", bg="#ef233c", height=2, font=('times', 15))
lbl6.place(x=400, y=400)

message3 = tk.Label(window, text="", fg="#edf2f4", bg="#ef233c",
                    activeforeground="green", width=50, height=5, font=('times', 15, ' bold '))
        ...
        for (x, y, w, h) in faces:
            ...
            if (conf < 50):
                ...
                timeStamp = datetime.datetime.fromtimestamp(
                    ts).strftime('%H:%M:%S')
                listdoctors = {"Leslie": 101, "Francis": 102,
                               "Pramod": 201, "Subhash": 202, "Chris": 301, "Myron": 302}
                ...
                tokentime = datetime.datetime.fromtimestamp(
                    ts).strftime('%H%M')
...
trackImg = tk.Button(window, text="Recognise Face", command=TrackImages, fg="#edf2f4",
