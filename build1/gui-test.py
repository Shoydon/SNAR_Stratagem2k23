...
def PatientUI():
    ...
    def TakeImages():        
        ...
        if(is_number(Id) and name.isalpha()):
            ...
            if(name.isalpha()):
                ...
                message.configure(text= res)
        folder_path="D:\Hackathons\GDA CRCE Hackthon\Face-Recognition-Based-Attendance-System-master\Hospital Appointment System\TrainingImage\Trainner.yml"
    ...
    trainImg = tk.Button(window, text="Submit Images", command=TrainImages  ,fg="#edf2f4"  ,bg="#3a86ff"  ,width=20  ,height=3, activebackground = "#d90429" ,font=('times', 15, ' bold '))
        ...
        while True:
            ...
            for(x,y,w,h) in faces:
                ...
                if(conf < 50):
                    ...
                    token=f"{tokennumber}:"+H+M

                    # tokentime=datetime.datetime.fromtimestamp(ts).strftime('%H%M%S')
                    # token=f"{tokennumber}:"+H+M+S
